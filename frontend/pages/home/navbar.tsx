      ...
      <nav className="mx-auto max-w-7xl px-6 py-4">
        ...
        <Link href="/" className="flex items-center gap-3">
          ...
          <ul className="hidden items-center gap-8 md:flex">
            <li>
              <Link href="/about" className="nav-link-gold">About</Link>
            </li>

            <li>
              <Link href="/services" className="nav-link-gold">
                Services & Pricing
              </Link>
            </li>

            <li>
              <Link href="/portfolio" className="nav-link-gold">
                Portfolio
              </Link>
            </li>

            <li>
              <Link href="/faq" className="nav-link-gold">FAQ & Policies</Link>
            </li>

            <li>
              <Link href="/contact" className="nav-link-gold">Contact Us</Link>
            </li>
          </ul>
